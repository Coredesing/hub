...
class RefetchMarketplaceEvent {
  ...
  static get key() {
    return 'RefetchMarketPlaceEvent-job'
  }
  ...
  async fetchEvents(provider, event_type, from, to) {
    console.log(`refetch ${event_type} from ${from} to ${to} in marketplace`)
...
module.exports = RefetchMarketplaceEvent
