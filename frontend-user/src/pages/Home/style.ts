  ...
  return {
    section: {
      ...
      '& .rectangle': {
        ...
        '&.bl::before': {
          background: 'linear-gradient(180deg, #0A0A0A 0%, rgba(23, 23, 23, 0) 0.01%, #0A0A0A 57.29%)'
        },
        '&.gr::before': {
          background: 'linear-gradient(180deg, #0A0A0A 0%, rgba(23, 23, 23, 0) 0.01%, #171717 57.29%)'
        }
      }
    },
    banner: {
