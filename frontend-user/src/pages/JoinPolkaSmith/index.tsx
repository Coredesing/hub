...
const JoinPolkaSmith = (props: any) => {
    ...
    const [executeTime, setExecuteTime] = useState("00:00")
                    ...
                    <div ref={myRef} className={styles.introMain}>
                                    ...
                                    {!currentWallet ?
                                        ...
                                        <div style={{
                                            ...
                                            <div className={styles.detailInfo}>
                                                ...
                                                <h2>{isLoadingContributed ?
                                                    <img src={loading} width={25} height={25}/> :
                                                    formatNumber(contributed * 500 / ksmDecimals, 0, false)} RKPoints <img src={infoIcon} width={15} height={15} ref={setTriggerRef}/></h2>
                                                {visible && (
                                                    <div
                                                        ref={setTooltipRef}
                        ...
                        <Collapse isOpen={currentWallet !== null}>
                            ...
                            <span>I have read and accepted the <a href={"/#/polkasmith-privacy"} target={"_blank"}
                                                                  style={{color: "#6398FF"}}><b>Term and Conditions</b></a> as well as the <a href={"https://redkite.polkafoundry.com/#/privacy"} target={"_blank"} style={{color: "#6398FF"}}>Privacy Policy</a>.
