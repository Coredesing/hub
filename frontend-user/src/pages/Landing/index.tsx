...
const teleIcon = '/images/landing/tele.svg'
const shuttleIcon = '/images/landing/shuttle.svg'
          ...
          <div className="main-content">
            ...
            <Fade bottom>
              <div className="buttons">
                <a href='https://docs.google.com/forms/d/e/1FAIpQLSe4_VUbD_KoJWYfDn2iYKCBmHo8O_sZ436RZLVn5J4v3wTCFA/viewform'
                    target="_blank">
                  ...
                  <div className={styles.projectDetail}>
                    <Fade bottom delay={500}>
                      ...
                      <a className={"btn"} href="/#/dashboard">
                        <button className={styles.btn}>Join Pools</button>
                      </a>
                    </Fade>
                    <Fade bottom delay={500}>
                      <a href={'#'}><img width={"90%"} src={projectBg}/></a>
                    </Fade>
                  </div>
                </Fade>
              </div>
              <div className={styles.projectContainer}>
                <Fade bottom delay={500}>
                  <div className={styles.projectDetail}>
                    ...
                    <Fade bottom delay={500}>
                      <a href="/#/join-polkasmith"><img width={"90%"} src={contributeBg}/></a>
                    </Fade>
                  </div>
                </Fade>
              </div>
        ...
        <div className={styles.container}>
          ...
          <div className="main-content">
            <LightSpeed delay={1500} left>
              <div className="title">
                <h2 className={common.nnb1214d}>Want to launch your project
                  {isWidthUp('sm', props.width) && <br/>} on {isWidthDown('xs', props.width) && <br/>}
                  Red Kite?</h2>
              </div>
              <div className="buttons">
                <a href='https://docs.google.com/forms/d/e/1FAIpQLSe4_VUbD_KoJWYfDn2iYKCBmHo8O_sZ436RZLVn5J4v3wTCFA/viewform'
