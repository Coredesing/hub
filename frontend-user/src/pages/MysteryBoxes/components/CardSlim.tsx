  ...
  return (
    <div className={`${styles.card} ${styles.slim}`}>
      ...
      <div className={styles.information}>
        <Link to={`/mystery-box/${item.id}`} className={styles.title}>
          {item.title} <img src={networkImage(item.network_available)} alt={item.network_available} />
        </Link>
        <div className={styles.socials}>
          ...
          { item.telegram_link && <a href={item.telegram_link} className={styles.social} target="_blank" rel="noopenner noreferrer">
          ...
          { item.twitter_link && <a href={item.twitter_link} className={styles.social} target="_blank" rel="noopenner noreferrer">
            <svg width="16" height="14" viewBox="0 0 16 14" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          { item.medium_link && <a href={item.medium_link} className={styles.social} target="_blank" rel="noopenner noreferrer">
            <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
