    ...
    <div className={clsx(styles.card, styles.cardComp)}>
      <div className={styles.cardCompBody}>
        ...
        <div className={styles.cardCompItem}>
          <span className={clsx(styles.text, styles.compText)}>Total sales</span>
          <span className={styles.textBold} style={{fontSize: '20px', lineHeight: '28px'}}>
            {card.total_sold_coin || 0}
          </span>
        </div>
        <div className={clsx(styles.cardCompItem, styles.cardCompProgress)}>
          <div className="title">
            <span style={{paddingTop: '5px'}} className={clsx(styles.text, styles.compText)}>PROGRESS</span>
            <span >
              ...
              <span className={clsx(styles.text, styles.compText)}>
                {card.token_sold || '...'}/{card.total_sold_coin || '...'} {card.tokenSymbol}
              </span>
            </span>
          </div>
