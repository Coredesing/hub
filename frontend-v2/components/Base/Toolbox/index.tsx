    ...
    <>
      <div className="fixed w-full bottom-0 grid grid-cols-5 md:hidden dark:bg-gamefiDark-700" style={{ boxShadow: 'inset -1px 0px 0px #303442', zIndex: '1000' }}>
        ...
        <ToolboxItem path='/hub'>
          <svg width="60" height="45" viewBox="0 0 60 45" fill="none" xmlns="http://www.w3.org/2000/svg" className="absolute top-0.5 -right-2.5">
            <g filter="url(#filter1_d_8086_18133)">
              <rect x="14" y="11" width="28" height="13" rx="1" fill="url(#paint1_linear_8086_18133)"/>
            </g>
            ...
            <defs>
              <filter id="filter1_d_8086_18133" x="0" y="0" width="60" height="45" filterUnits="userSpaceOnUse" colorInterpolationFilters="sRGB">
              ...
              <linearGradient id="paint1_linear_8086_18133" x1="15.5" y1="11" x2="40.5" y2="24" gradientUnits="userSpaceOnUse">
