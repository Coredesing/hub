...
const Profile = () => {
  ...
  return <div className='py-10 px-9'>
    ...
    <div className='w-full flex gap-5 mb-16'>
      <div className={clsx(styles.box, 'w-2/3 p-7 rounded-sm')}>
        ...
        <div className='mb-7'>
          ...
          <div className={clsx(styles.walletBox, 'py-3 pl-2 pr-4 rounded-sm flex items-center')}>
            <div className={clsx(styles.mainWalletIcons, 'flex items-center mr-4')}>
              <div className='w-8 h-8 rounded-full'>
                <svg width="34" height="34" viewBox="0 0 34 34" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <circle cx="17" cy="17" r="16" fill="#546BC7" stroke="#282A33" stroke-width="2" />
              ...
              <div className='w-8 h-8 rounded-full'>
                <svg width="34" height="34" viewBox="0 0 34 34" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <circle cx="17" cy="17" r="16" fill="#FFD22A" stroke="#282A33" stroke-width="2" />
              ...
              <div className='w-8 h-8 rounded-full'>
                <svg width="34" height="34" viewBox="0 0 34 34" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <circle cx="17" cy="17" r="16" fill="#AA83EB" stroke="#282A33" stroke-width="2" />
            ...
            <div className='flex justify-between gap-2 w-full items-center'>
              <span className='font-casual text-13px text-white/80 break-words break-all text-ellipsis'>0xFA8f12098BAFASDccc1219gko123974kvkKKASDFJLJK1234</span>
              <span>
                <DocumentCopyIcon />
              </span>
            </div>
      ...
      <div className={clsx(styles.box, 'w-1/3 rounded-sm p-7 h-fit')}>
        ...
        <div className='grid grid-cols-2 items-center justify-between gap-2 mb-4'>
          ...
          {
            isStaked && isKyc && <div className='flex gap-2 justify- items-center'>
        ...
        {
          teleAcc && <div className='grid grid-cols-2 items-center justify-between mb-4'>
            <label className='text-sm font-casual' htmlFor="">Twitter Account</label>
            <div className='text-sm font-casual text-white/50 text-right'>{teleAcc}</div>
          </div>
        }
        {
          twitterAcc && <div className='grid grid-cols-2 items-center justify-between mb-4'>
            <label className='text-sm font-casual' htmlFor="">Telegram Account</label>
            <div className='text-sm font-casual text-white/50 text-right'>{twitterAcc}</div>
          </div>
        }
        {
          !isStaked && <div>
      ...
      <div className={clsx(styles.steps)}>
        <div className={clsx(styles.step)}>
          ...
          <div className='text-sm text-white/80 font-casual mb-6'>
            Check out GameFi's ranking system: Legend, Pro, Elite, Rookie. <a className={clsx(styles.link, 'font-bold text-sm font-casual')}>Read more</a>
          </div>
        ...
        <div className={clsx(styles.step)}>
          ...
          <a className={clsx(styles.link, 'font-bold text-sm font-casual')}>How to KYC via Blockpass</a>
        </div>
        <div className={clsx(styles.step)}>
          ...
          <a className={clsx(styles.link, 'font-bold text-sm font-casual')}>How to join IGO/INO pools</a>
        </div>
      </div>
    </div>
  </div>
