    ...
    <div className="flex flex-col h-[600px] md:h-auto md:flex-1 bg-[#1B1D26] relative">
      <div className="flex flex-col md:flex-row md:items-center w-full p-6 pt-8">
        <div className="flex items-center">
          ...
          {data?.tutorialUrl && (
            <a
              href={data.tutorialUrl}
              className="text-gamefiGreen-700 p-2 md:px-5 cursor-pointer font-medium hover:underline"
              target="_blank"
              rel="noreferrer"
            >
              Guideline
        ...
        <p className="font-casual text-sm text-gamefiYellow md:ml-auto p-2 md:p-0 md:pl-10">
          ...
          {data?.accountType === 'WALLET'
            ? !account
              ? 'Connect wallet'
              : `You must use the wallet ${shorten(account)} to play this game.`
            : ''}
        </p>
      </div>
                  ...
                  Get Gafish
                      <div className="flex items-center">
                        <Tippy
                          content={
                            <span>
                          You need to click this button once only to start
                          tracking progress and earning gafish
                            </span>
                          }
