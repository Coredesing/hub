...
const GuildCard = ({ item, isDraft }: { item: any; isDraft?: boolean }) => {
  ...
  return isDraft
    ...
    : <div onClick={() => { router.push(`/guilds/${item.slug}`) }} className="bg-gamefiDark-630/30 cursor-pointer w-full flex flex-col font-casual hover:opacity-90 clipped-b-r h-[450px] md:h-[500px]">
