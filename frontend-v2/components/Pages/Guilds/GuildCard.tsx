...
const GuildCard = ({ item, isDraft }: { item: any; isDraft?: boolean }) => {
  ...
  return isDraft
    ? <div className="bg-gamefiDark-630/30 cursor-pointer w-full flex flex-col font-casual hover:opacity-90 clipped-b-r"></div>
    : <div onClick={() => { router.push(`/guilds/${item.id}`) }} className="bg-gamefiDark-630/30 cursor-pointer w-full flex flex-col font-casual hover:opacity-90 clipped-b-r">
