  ...
  return (
    <div className={`w-full rounded overflow-hidden border border-transparent hover:opacity-80 ${props.className}`}>
      ...
      <div className="bg-gamefiDark-650 w-full clipped-b-l">
        ...
        {
          !item?.start_time && ['tba', 'upcoming'].includes(item.campaign_status?.toLowerCase()) && !item?.start_join_pool_time && <div className="py-3 w-full flex flex-col items-center justify-center">
