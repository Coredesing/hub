...
const GameFiPerformance = ({ item } : { item: any }) => {
  ...
  return ((screens.mobile || screens.tablet)
    ? <>
      <div className="container">
        <div className="relative w-full px-6 py-5 bg-gamefiDark-800 rounded-sm">
          ...
          <div className="mt-6 flex flex-col" style={{
            background: 'linear-gradient(91.27deg, rgba(255, 255, 255, 0.03) 37.59%, rgba(255, 255, 255, 0) 101.09%)',
            border: '1px solid rgba(255, 255, 255, 0.1)'
          }}>
            <div className="px-6 py-4 flex flex-col justify-center border-b border-gamefiDark-600 pr-10 md:pr-14">
            ...
            <div className="w-full py-4 px-6 font-casual">
