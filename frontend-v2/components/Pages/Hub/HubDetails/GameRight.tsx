  ...
  return (
    <>
      <div className='mb-6' style={{ marginTop: 'auto', position: 'relative' }}>
        ...
        <Link href={`/igo/${'id'}`} passHref={true}>
          <a className={styles.actionBtn}> <span className='mr-2'>Join Now</span> <Image src={require('@/assets/images/icons/arrow-right-dark.svg')} alt="right" /></a>
        </Link>
      </div>
    </>
  )
