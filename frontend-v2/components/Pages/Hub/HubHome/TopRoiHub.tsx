  ...
  return (
    <div className="mb-6">
      <div className="flex justify-between mb-3 md:text-lg 2xl:text-2xl items-center">
        <Tippy content={<div><div>Token ROI is the approximate current return on investment (ROI) of a token.</div><div>Token ROI = Current Price/Public Sale Price</div></div>} className="font-casual text-sm leading-5 text-white bg-black opacity-100 p-3">
          <div className="flex">
