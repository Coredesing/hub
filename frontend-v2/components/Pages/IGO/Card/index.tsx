    ...
    <div className="px-4 py-4 flex flex-col gap-4">
      ...
      <div className="w-full grid grid-cols-2 gap-2">
        <div className="text-left">
          ...
          {item.process === 'only-buy' ? <div className="text-sm">-</div> : <div className="text-sm">${Math.round(Number(item?.total_sold_coin) * Number(item?.token_conversion_rate)).toLocaleString('en-US')}</div>}
        </div>
        <div className="text-left">
