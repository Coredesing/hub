...
const GuildDetail = ({ item }: {item: any}) => {
  const [tab, setTab] = useState(0)
  const router = useRouter()
  return (
    <Layout title={`GameFi.org - ${'Guild'}`} description="" extended={true}>
      <div className="absolute top-0 left-0 right-0 z-0">
        <div className="w-full h-[310px] relative" style={{
          ...
          <img className="object-cover w-full" src="https://file.coin98.com/insights/yield-guide-game-1628391767889.png" alt=""></img>
        </div>
      </div>
      <div className="container mx-auto px-4 xl:px-16 mt-28 relative">
        ...
        <div className="w-full flex gap-5">
          <div className="w-52 h-52 rounded shadow overflow-hidden">
            <img src="https://coinexpress.net/wp-content/uploads/2021/09/YGG.webp" alt="" className="object-cover w-full h-full"></img>
          </div>
          <div className="flex-1 flex flex-col justify-center gap-2">
            <div className="flex justify-between w-full">
              <div className="text-2xl uppercase font-bold mb-2">Yield Guild Games</div>
            ...
            <div className="font-semibold">20 Games • 1.2K members</div>
          </div>
        </div>
      </div>
