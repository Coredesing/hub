                ...
                <Link href={`/hub/${item.slug}`} key={item.id} passHref={true}>
                  <div className="flex items-center bg-gamefiDark-650 hover:bg-gamefiDark-600 mb-4 cursor-pointer">
                    <div className="flex-1 flex items-center overflow-hidden">
                      ...
                      <div className="p-4 flex-1 overflow-hidden">
                        ...
                        <p className="flex gap-3 mt-2 items-center">
                          { item?.official_website && <a href={item?.official_website} className="hover:text-gray-300" target="_blank" rel="noopenner noreferrer" onClick={e => e.stopPropagation()}>
                            <svg className="w-4 h-4" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                          ...
                          { item?.official_telegram_link && <a href={item?.official_telegram_link} className="hover:text-gray-300" target="_blank" rel="noopenner noreferrer" onClick={e => e.stopPropagation()}>
                          ...
                          { item?.twitter_link && <a href={item?.twitter_link} className="hover:text-gray-300" target="_blank" rel="noopenner noreferrer" onClick={e => e.stopPropagation()}>
                            <svg className="w-4 h-4" viewBox="0 0 16 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                          ...
                          { item?.medium_link && <a href={item?.medium_link} className="hover:text-gray-300" target="_blank" rel="noopenner noreferrer" onClick={e => e.stopPropagation()}>
                            <svg className="w-4 h-4" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div className="flex-none font-casual text-sm w-48 hidden 2xl:block">
                      ...
                      { item.price_change_7d && <img src={`https://${CMC_ASSETS_DOMAIN_CHART}/generated/sparklines/web/7d/usd/${item.cmc_id}.svg`} alt={`CoinMarketCap ${item.game_name}`} className={parseFloat(item.price_change_7d || 0) > 0 ? 'hue-rotate-90' : '-hue-rotate-60 -saturate-150 contrast-150 brightness-75'} /> }
                    </div>
                  </div>
                </Link>
              )
